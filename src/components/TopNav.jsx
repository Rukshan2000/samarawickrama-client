    ...
    <nav className="relative sticky top-0 z-10 p-5 bg-white shadow md:flex md:items-center md:justify-between">
      <div className="flex items-center justify-between">
        ...
        <span className="block mx-2 text-3xl cursor-pointer md:hidden" onClick={toggleMenu}>
          {isOpen ? (
            <svg className="h-8 text-green-500 w-9" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <ul className={`md:flex md:items-center md:static absolute bg-white w-full left-0 md:w-auto md:py-0 py-4 md:pl-0 pl-10 md:opacity-100 ${isOpen ? 'top-16 opacity-100' : 'top-full opacity-0'} justify-center`}>
        <li className="mx-4 my-6 text-lg font-bold text-green-600 duration-500 hover:text-orange-300 font-Poppins md:my-0 hover:underline">
        ...
        <li className="relative mx-4 my-6 text-lg font-bold text-green-600 duration-500 hover:text-orange-300 font-Poppins md:my-0 hover:underline">
          ...
          <ul className={`absolute top-full left-0 bg-white shadow-md p-2 rounded-md mt-1 w-36 ${isDropdownOpen ? 'block' : 'hidden'}`}>
            <li className="py-1">
              <RouterLink to="/blogpage" className="text-gray-700 hover:text-green-600">Blog</RouterLink>
            </li>
            <li className="py-1">
              <RouterLink to="/toolspage" className="text-gray-700 hover:text-green-600">Tools</RouterLink>
            </li>
          </ul>
        </li>
        <li className="mx-4 my-6 text-lg font-bold text-green-600 duration-500 hover:text-orange-300 font-Poppins md:my-0 hover:underline">
